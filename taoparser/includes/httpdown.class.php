...
class HttpDown
{
	...
	function printError()
	{
		echo 'error_message'.$this->m_error;
		echo "<br/>".'Specific_returnhead'."<br/>";
	...
	function IsText()
	{
		...
		{
			$this->m_error .= 'content_urlredirection'."<br/>";
			return false;
		}
	}
	...
	function IsContentType($ctype)
	{
		...
		{
			$this->m_error .= 'Wrong_type'.$this->GetHead("content-type")."<br/>";
			return false;
		}
	}
	...
	function SaveToBin($savefilename)
	{
		...
		if(@feof($this->m_fp))
		{
			$this->m_error = 'Connection_closed'; return false;
		}
	...
	function PrivateStartSession($requestType="GET")
	{
		...
		if(ereg("^3",$this->m_httphead["http-state"]))
		{
			...
			{
				$this->m_error = 'not_recognize_answer';
			}
		}
	}
